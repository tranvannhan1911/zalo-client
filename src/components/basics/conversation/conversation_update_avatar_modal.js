...
const ConversationUpdateAvatarModal = ({ openUpdateAvatarModal, setOpenUpdateAvatarModal, info, file, conversationId }) => {
...
export default ConversationUpdateAvatarModal;